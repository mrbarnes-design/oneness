...
<div class="large-hero">
      <img src="<?php echo get_theme_file_uri('images/hero--large.jpg') ?>" alt="">
    ...
    <div id="our-beginning" class="page-section" data-matching-link="#our-beginning-link">
      <div class="wrapper">
        ...
        <div class="wrapper wrapper--medium wrapper--b-margin">
          <img loading="lazy" sizes="(min-width: 970px) 976px, 100vw" srcset="assets/images/first-trip-low-res.jpg 565w, assets/images/first-trip.jpg 976w, assets/images/first-trip-hi-dpi.jpg 1952w" alt="Couple walking down a street." />
        </div>
        ...
        <div class="row row--gutters">
          <div class="row__medium-4 row__medium-4--larger row__b-margin-until-medium">
            <picture>
              ...
              <img loading="lazy" srcset="assets/images/our-start-landscape.jpg 800w, assets/images/our-start-landscape-hi-dpi.jpg 1600w" alt="Our founder, Jane Doe" />
            </picture>
          </div>
    ...
    <div id="features" class="page-section page-section--blue" data-matching-link="#features-link">
      <div class="wrapper">
        <h2 class="section-title"><img loading="lazy" class="section-title__icon" src="assets/images/icons/star.svg" /> Our <strong>Features</strong></h2>

        <div class="row row--gutters-large generic-content-container">
          <div class="row__medium-6">
            <div class="feature-item">
              <img loading="lazy" class="feature-item__icon" src="assets/images/icons/rain.svg" />
            ...
            <div class="feature-item">
              <img loading="lazy" class="feature-item__icon" src="assets/images/icons/globe.svg" />
          ...
          <div class="row__medium-6">
            <div class="feature-item">
              <img loading="lazy" class="feature-item__icon" src="assets/images/icons/wifi.svg" />
            ...
            <div class="feature-item">
              <img loading="lazy" class="feature-item__icon" src="assets/images/icons/fire.svg" />
    ...
    <div id="testimonials" class="page-section page-section--no-b-padding-until-large page-section--testimonials" data-matching-link="#testimonials-link">
      <div class="wrapper wrapper--no-padding-until-large">
        <h2 class="section-title section-title--blue"><img loading="lazy" class="section-title__icon" src="assets/images/icons/comment.svg" /> Real <strong>Testimonials</strong></h2>
        ...
        <div class="row row--gutters row--equal-height-at-large row--gutters-small row--t-padding generic-content-container">
          <div class="row__large-4">
            <div class="testimonial">
              <div class="testimonial__photo">
                <img loading="lazy" sizes="160px" srcset="assets/images/testimonial-jane.jpg 160w, assets/images/testimonial-jane-hi-dpi.jpg 320w" alt="Jane Doe" />
              </div>
          ...
          <div class="row__large-4">
            <div class="testimonial">
              <div class="testimonial__photo">
                <img loading="lazy" sizes="160px" srcset="assets/images/testimonial-john.jpg 160w, assets/images/testimonial-john-hi-dpi.jpg 320w" alt="John Smith" />
              </div>
          ...
          <div class="row__large-4">
            <div class="testimonial testimonial--last">
              <div class="testimonial__photo">
                <img loading="lazy" sizes="160px" srcset="assets/images/testimonial-cat.jpg 160w, assets/images/testimonial-cat-hi-dpi.jpg 320w" alt="Cat McKitty" />
              </div>
